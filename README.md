# Battleship: working through complexity
...
```bash
git clone https://github.com/carlDguez19/odinBattleship2.git
cd odinBattleship2
npm install
```
...
Built by Carlos Dominguez, a systems-oriented developer and designer whos foundation is pure relentless persistance.
